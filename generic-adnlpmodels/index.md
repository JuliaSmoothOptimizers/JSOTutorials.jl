---
author: "Tangi Migot"
title: "Multiprecision and genericity in NLPModels with automatic differentiation"
tags:
  - "models"
...
# Multiprecision and genericity in NLPModels with automatic differentiation
...
Note that most of the solvers available in [JuliaSmoothOptimizers](https://juliasmoothoptimizers.github.io) have a flexible working type.
...
In this tutorial, we will show how to modify the AD-backend in `ADNLPModel` so that the precision can also be changed during the execution of the algorithm.
...
(0.0,6.93217155621163e-310,6.9321722525114e-310), Dual{ForwardDiff.Tag{type
of(Main.var"##WeaveSandBox#312".f), Float64}}(0.0,6.93217155621163e-310,6.9
3217155479346e-310)]))
```
